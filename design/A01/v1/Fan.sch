...
Wire Wire Line
	3400 3250 3400 3150
$Comp
L Jetbot-Mini-rescue:GND-power #PWR036
U 1 1 5F392EED
P 3400 3600
...
$EndComp
$Comp
L Jetbot-Mini-rescue:+1V8-power #PWR038
U 1 1 5F39419E
P 4650 2050
...
$EndComp
$Comp
L Jetbot-Mini-rescue:+5V-power #PWR040
U 1 1 5F394806
P 4850 2050
...
$EndComp
$Comp
L Jetbot-Mini-rescue:GND-power #PWR039
U 1 1 5F394EE6
P 4750 3600
...
Wire Wire Line
	4750 3600 4750 3550
$Comp
L Jetbot-Mini-rescue:GND-power #PWR042
U 1 1 5F395612
P 5400 3600
...
U 1 1 5F3965F5
P 7150 2950
F 0 "J9" H 7230 2987 50  0000 L CNN
F 1 "Conn_01x04" H 7230 2896 50  0000 L CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x04_P2.54mm_Vertical" H 7150 2950 50  0001 C CNN
F 3 "~" H 7150 2950 50  0001 C CNN
F 4 "NS" H 7230 2805 50  0000 L CNB "NS"
	1    7150 2950
	1    0    0    -1  
$EndComp
$Comp
L Jetbot-Mini-rescue:DMN2230U-Transistor_FET Q?
U 1 1 5F39AAC8
P 5700 4200
AR Path="/5F2424D1/5F39AAC8" Ref="Q?"  Part="1" 
AR Path="/5F38CF22/5F39AAC8" Ref="Q2"  Part="1" 
F 0 "Q2" H 5905 4433 50  0000 L CNN
F 1 "DMN26D0UT-7" H 5905 4342 50  0000 L CNN
...
F 4 "SOT-523" H 5905 4259 39  0000 L CNN "Package"
F 5 "Vgs = ±10V" H 5905 4184 39  0000 L CNN "Vgs"
F 6 "Vds = 20V" H 5905 4109 39  0000 L CNN "Voltage"
F 7 "Id = 0.23A" H 5905 4034 39  0000 L CNN "Current"
F 8 "" H 5904 4072 39  0001 L CNN "Max Current"
F 9 "Vgs(th, max) = 1V" H 5905 3959 39  0000 L CNN "Vgs, th"
	1    5700 4200
	1    0    0    -1  
$EndComp
$Comp
L Jetbot-Mini-rescue:+1V8-power #PWR041
U 1 1 5F39F326
P 5200 4150
...
Wire Wire Line
	5800 3050 5950 3050
$Comp
L Jetbot-Mini-rescue:+5V-power #PWR043
U 1 1 5F3A422B
P 5950 2250
...
$EndComp
$Comp
L Jetbot-Mini-rescue:GND-power #PWR044
U 1 1 5F3A4BEB
P 6150 2850
...
Wire Wire Line
	6700 2950 6950 2950
$Comp
L Jetbot-Mini-rescue:GND-power #PWR045
U 1 1 5F3A8043
P 7100 2600
...
NS Fan Header so user should solder on male headers. 
Wire Wire Line
	5150 3150 5400 3150
Wire Wire Line
	5400 3200 5400 3150
...
$EndComp
$Comp
L Jetbot-Mini-rescue:GND-power #PWR065
U 1 1 5F3B7899
P 5150 2600
...
Wire Wire Line
	4650 2100 4650 2750
$Comp
L Jetbot-Mini-rescue:GND-power #PWR062
U 1 1 5F3BFE75
P 4200 2600
...
U 1 1 60FB3919
P 3400 3400
AR Path="/5F07E815/60FB3919" Ref="R?"  Part="1" 
AR Path="/5F38CF22/60FB3919" Ref="R8"  Part="1" 
...
F 3 "https://datasheet.lcsc.com/lcsc/Uniroyal-Elec-0402WGF1003TCE_C25741.pdf" H 3400 3400 50  0001 C CNN
F 4 "0402" H 3468 3347 39  0000 L CNN "Package"
F 5 "0.0008" H 3400 3400 50  0001 C CNN "Price"
F 6 "1%" H 3468 3272 39  0000 L CNN "Tolerance "
F 7 "0402WGF1003TCE" H 3400 3400 50  0001 C CNN "MPN"
	1    3400 3400
	1    0    0    -1  
$EndComp
$Comp
L Jetbot_Mini_Symbols:PI4ULS5V201TAEX U30
U 1 1 619F127E
P 4750 2600
AR Path="/5F38CF22/619F127E" Ref="U30"  Part="1" 
AR Path="/5F227AB4/619F127E" Ref="U?"  Part="1" 
F 0 "U30" H 3750 1800 50  0000 L CNN
F 1 "PI4ULS5V201TAEX" H 3750 1700 50  0000 L CNN
F 2 "Package_TO_SOT_SMD:SOT-23-6" H 4750 2150 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/sn74lvc1t45.pdf" H 3850 1950 50  0001 C CNN
F 4 "SOT-23-6" H 3750 1650 39  0000 L CNN "Package"
	1    4750 2600
	1    0    0    -1  
$EndComp
$EndSCHEMATC
